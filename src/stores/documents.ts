...
export const useDocumentStore = defineStore('documents', () => {
  ...
  async function fetchList (): Promise<void> {
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : '文書の取得に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function create (
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : '文書の作成に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function update (
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : '文書の更新に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function remove (id: string): Promise<void> {
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : '文書の削除に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
