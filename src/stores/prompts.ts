...
export const usePromptStore = defineStore('prompts', () => {
  ...
  async function fetchList (): Promise<void> {
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : 'プロンプトの取得に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function create (
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : 'プロンプトの作成に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function update (
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : 'プロンプトの更新に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
  ...
  async function remove (id: string): Promise<void> {
    ...
    try {
      ...
      error.value = error_ instanceof Error ? error_.message : 'プロンプトの削除に失敗しました'
      throw error_
    } finally {
      loading.value = false
    }
